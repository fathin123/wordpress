	...
	class Zakra_Dynamic_CSS {
		...
		public static function render_output( $dynamic_css, $dynamic_css_filtered = '' ) {
			...
			$base_border_color_css = array(
				'.tg-site-header, .tg-primary-menu, .tg-primary-menu > div ul li ul, .tg-primary-menu > div ul li ul li a, .posts-navigation, #comments, .widget ul li, .post-navigation, #secondary, .tg-site-footer .tg-site-footer-widgets, .tg-site-footer .tg-site-footer-bar .tg-container, .wp-block-button .wp-block-button__link' => array(
		...
		public static function render_wc_output( $dynamic_css, $dynamic_css_filtered = '' ) {
			...
			$parse_wc_css             .= zakra_parse_dimension_css(
				...
				$button_wc_padding,
				'.woocommerce a.button, .woocommerce a.button.alt, .woocommerce button.button, .woocommerce button.button.alt, .woocommerce ul.products a.button, .woocommerce div.product form.cart .button, .woocommerce ul.products li.product .button, .woocommerce button.button:disabled[disabled], .tg-sticky-panel .tg-checkout-btn a',
				'padding'
			);
